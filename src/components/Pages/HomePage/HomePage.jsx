  ...
  return (
    <div className="home">
      ...
      <ul className="home__list features">
        ...
        <li className="features__text">
          <span className="features__title">New video preview toggle.</span>You
          can now preview your camera before you go on video. Visit User
          Settings Voice, Video to turn this feature on/off, but leave it on if
          you keep your laundry on that one chair behind you.
        </li>
        <li className="features__text">
          <span className="features__title">
        ...
        <li className="features__text">
          <span className="features__title">Improvements to GIF cropper.</span>{" "}
      ...
      <ul className="home__list safety">
        ...
        <li className="features__text">
          ...
          This new system can also better warn you before you visit a malicious
          domain. Don't click suspicious links. Free Nitro for your login
          information is a lie. Discord employees don’t want your password. We
          can barely remember our own.
        </li>
      </ul>
    </div>
  );
